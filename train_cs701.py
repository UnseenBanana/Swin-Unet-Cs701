...
from trainer_cs701 import trainer_cs701
...
parser.add_argument(
    "--root_path",
    type=str,
    default="./datasets/cs701_224",
    help="root dir for data",
)
parser.add_argument("--dataset", type=str, default="cs701", help="experiment_name")
parser.add_argument(
    "--list_dir", type=str, default="./lists/lists_cs701", help="list dir"
)
parser.add_argument(
    "--num_classes", type=int, default=13, help="output channel of network"
)
